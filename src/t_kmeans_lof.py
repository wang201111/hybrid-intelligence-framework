...
This module targets ternary solubility systems with 3 input columns
[Temperature, w_comp1, w_comp2].

Detection follows a unified pipeline:
...
class OutlierDetectionConfig:
    ...
    Attributes:
        contamination: Expected proportion of outliers in dataset [0.0, 0.5].
            If None, uses the system default (solubility: 0.20).
        ...
        max_n_clusters: Maximum number of clusters to try. Will be capped by
            the system default (solubility: 24).
...
class TKMeansLOF:
    ...
    Attributes:
        ...
        system_type: System type (only 'solubility' is supported).
    ...
    def __init__(
        ...
        Raises:
            ValueError: If system_type is not 'solubility'.
    ...
    def _compute_moving_median_residuals(
        ...
        # Sort by the configured feature (w_comp1 for solubility)
