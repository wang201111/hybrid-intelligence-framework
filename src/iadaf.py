...
Targets ternary solubility systems:
...
class IADAFConfig:
    ...
    # ========== System Type ==========
    SYSTEM_TYPE: str = 'solubility'  # only 'solubility' is supported
    ...
    def __post_init__(self):
        ...
        if self.SYSTEM_TYPE != 'solubility':
            raise ValueError(
...
class Generator(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            output_dim: Output dimension (1 for solubility).
            hidden_dim: Hidden layer dimension.
            dropout: Dropout rate.
        """
        super().__init__()
...
class Critic(nn.Module):
    ...
    def __init__(
        ...
        Args:
            input_dim: Input dimension (1 for solubility).
...
class IADAFTrainer:
    ...
    def _generate_samples(
        ...
        with torch.no_grad():
            # Generate solubility conditions: [T, w_comp1]
            T = np.random.uniform(
